    ...
    <div>
      ...
      <div className="intro-y grid grid-cols-12 gap-6 mt-5">
              ...
              <div className="text-center lg:text-left p-5">
                ...
                <div className="flex items-center justify-center lg:justify-start text-primary underline mt-5">
                  ...
                  <Link
                    to="#"
                    onClick={(e) => {
                      window.open("https://albertovalerio.com");
                    }}
                  >
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="intro-y box h-full">
            <div className="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
              <h2 className="font-medium text-base mr-auto">Credits</h2>
            </div>
            <div className="p-5">
              <div className="text-center lg:text-left">
                ...
                <div className="flex items-center justify-center lg:justify-start text-primary underline mt-5">
                  ...
                  <Link
                    to="#"
                    onClick={(e) => {
                      window.open("https://reactflow.dev/");
                    }}
                  >
                    Reactflow.dev
                  </Link>
                ...
                <div className="flex items-center justify-center lg:justify-start text-primary underline mt-5">
                  ...
                  <Link
                    to="#"
                    onClick={(e) => {
                      window.open("https://feathericons.com/");
                    }}
                  >
                    Feathericons.com
                  </Link>
